...
describe('hasAnyAuthority', () => {
  ...
  it('Should return false when authorities is valid and hasAnyAuthorities does not contain an authority', () => {
    ...
    expect(hasAnyAuthority([AUTHORITIES.STUDENT, AUTHORITIES.ADMIN], ['ROLE_USERSS'])).toEqual(false);
    expect(hasAnyAuthority([AUTHORITIES.STUDENT, AUTHORITIES.ADMIN], ['ROLEUSER', 'ROLEADMIN'])).toEqual(false);
  });
});
