...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './student-company-status.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTCOMPANYSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_STUDENTCOMPANYSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STUDENTCOMPANYSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STUDENTCOMPANYSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTCOMPANYSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STUDENTCOMPANYSTATUS actions', async () => {
      const expectedActions = [
        {
